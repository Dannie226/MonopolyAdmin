declare function Ammo<T>(): Promise<T & typeof Ammo>;
declare namespace Ammo {
    ...
    export function getPointer(obj: AmmoObj): number;
    export function destroy(obj: AmmoObj): void;
    export function wrapPointer(pointer, ctor);
    export function castObject(obj, ctor);
    export function UTF8ToString(chars: Uint8Array):string;

    export interface AmmoObj {

    }

    export class btIDebugDraw implements AmmoObj {
    ...
    export class DebugDrawer implements AmmoObj {
        constructor();
        drawLine(from: btVector3, to: btVector3, color: btVector3): void;
        drawContactPoint(pointOnB: btVector3, normalOnB: btVector3, distance: number, lifeTime: number, color: btVector3): void;
        reportErrorWarning(warningString: string): void;
    ...
    export class btVector3 implements AmmoObj {
        constructor();
    ...
    export class btQuadWord implements AmmoObj {
        x(): number;
        y(): number;
        z(): number;
        w(): number;
    ...
    export class btMotionState implements AmmoObj {
    ...
    export class btCollisionObject implements AmmoObj {
    ...
    export class btCollisionObjectWrapper implements AmmoObj {
        getWorldTransform(): btTransform;
        getCollisionObject(): btCollisionObject;
        getCollisionShape(): btCollisionShape;
    }
    export class RayResultCallback implements AmmoObj {
        hasHit(): boolean;
    ...
    export class btConstCollisionObjectArray implements AmmoObj {
        size(): number;
        at(n: number): btCollisionObject;
    }
    export class btScalarArray implements AmmoObj {
        size(): number;
        at(n: number): number;
    }
    ...
    export class btManifoldPoint implements AmmoObj {
    ...
    export class ContactResultCallback implements AmmoObj {
    ...
    export class ConcreteContactResultCallback implements AmmoObj {
        constructor();
        addSingleResult(cp: btManifoldPoint, colObj0Wrap: btCollisionObjectWrapper, partId0: number, index0: number, colObj1Wrap: btCollisionObjectWrapper, partId1: number, index1: number): number;
    }
    export class LocalShapeInfo implements AmmoObj {
    ...
    export class LocalConvexResult implements AmmoObj {
    ...
    export class ConvexResultCallback implements AmmoObj {
        hasHit(): boolean;
        get_m_collisionFilterGroup(): number;
        set_m_collisionFilterGroup(m_collisionFilterGroup: number): void;
        get_m_collisionFilterMask(): number;
    ...
    export class btCollisionShape implements AmmoObj {
    ...
    export class btIntArray implements AmmoObj {
        size(): number;
        at(n: number): number;
    }
    export class btFace implements AmmoObj {
    ...
    export class btVector3Array implements AmmoObj {
        size(): number;
        at(n: number): btVector3;
    }
    export class btFaceArray implements AmmoObj {
        size(): number;
        at(n: number): btFace;
    }
    export class btConvexPolyhedron implements AmmoObj {
    ...
    export class btShapeHull implements AmmoObj {
    ...
    export class btStridingMeshInterface implements AmmoObj {
        setScaling(scaling: btVector3): void;
    }
    export class btIndexedMesh implements AmmoObj {
        get_m_numTriangles(): number;
        set_m_numTriangles(m_numTriangles: number): void;
    }
    export class btIndexedMeshArray implements AmmoObj {
        size(): number;
    ...
    export class btDefaultCollisionConstructionInfo implements AmmoObj {
        constructor();
    }
    export class btDefaultCollisionConfiguration implements AmmoObj {
        constructor(info?: btDefaultCollisionConstructionInfo);
    }
    export class btPersistentManifold implements AmmoObj {
        constructor();
    ...
    export class btDispatcher implements AmmoObj {
    ...
    export class btOverlappingPairCallback implements AmmoObj {
    }
    export class btOverlappingPairCache implements AmmoObj {
        setInternalGhostPairCallback(ghostPairCallback: btOverlappingPairCallback): void;
        getNumOverlappingPairs(): number;
    }
    export class btAxisSweep3 implements AmmoObj {
    ...
    export class btBroadphaseInterface implements AmmoObj {
        getOverlappingPairCache(): btOverlappingPairCache;
    }
    export class btCollisionConfiguration implements AmmoObj {
    }
    export class btDbvtBroadphase extends btBroadphaseInterface {
        constructor();
    }
    export class btBroadphaseProxy implements AmmoObj {
        get_m_collisionFilterGroup(): number;
        set_m_collisionFilterGroup(m_collisionFilterGroup: number): void;
        get_m_collisionFilterMask(): number;
        set_m_collisionFilterMask(m_collisionFilterMask: number): void;
    }
    export class btRigidBodyConstructionInfo implements AmmoObj {
    ...
    export class btConstraintSetting implements AmmoObj {
        constructor();
        get_m_tau(): number;
    ...
    export class btTypedConstraint implements AmmoObj {
    ...
    export class btSequentialImpulseConstraintSolver implements AmmoObj {
        constructor();
    }
    ...
    export class btConstraintSolver implements AmmoObj {
    }
    export class btDispatcherInfo implements AmmoObj {
    ...
    export class btCollisionWorld implements AmmoObj {
    ...
    export class btContactSolverInfo implements AmmoObj {
    ...
    export class btVehicleTuning implements AmmoObj {
        constructor();
    ...
    export class btVehicleRaycasterResult implements AmmoObj {
    ...
    export class btVehicleRaycaster implements AmmoObj {
    ...
    export class RaycastInfo implements AmmoObj {
    ...
    export class btWheelInfoConstructionInfo implements AmmoObj {
    ...
    export class btWheelInfo implements AmmoObj {
        get_m_suspensionStiffness(): number;
        set_m_suspensionStiffness(m_suspensionStiffness: number): void;
        get_m_frictionSlip(): number;
        set_m_frictionSlip(m_frictionSlip: number): void;
    ...
    export class btActionInterface implements AmmoObj {
    ...
    export class btGhostPairCallback implements AmmoObj {
        constructor();
    }
    export class btSoftBodyWorldInfo implements AmmoObj {
        constructor();
    ...
    export class Face implements AmmoObj {
    ...
    export class tFaceArray implements AmmoObj {
        size(): number;
        at(n: number): Face;
    }
    export class Node implements AmmoObj {
        get_m_x(): btVector3;
    ...
    export class tNodeArray implements AmmoObj {
        size(): number;
        at(n: number): Node;
    }
    export class Material implements AmmoObj {
        get_m_kLST(): number;
    ...
    export class tMaterialArray implements AmmoObj {
        size(): number;
        at(n: number): Material;
    }
    export class Anchor implements AmmoObj {
        get_m_node(): Node;
    ...
    export class tAnchorArray implements AmmoObj {
        size(): number;
        at(n: number): Anchor;
        clear(): void;
    ...
    export class Config implements AmmoObj {
        get_kVCF(): number;
    ...
    export class btSoftBodySolver implements AmmoObj {
    }
    export class btDefaultSoftBodySolver extends btSoftBodySolver {
        constructor();
    }
    export class btSoftBodyArray implements AmmoObj {
        size(): number;
    ...
    export class btSoftBodyHelpers implements AmmoObj {
        constructor();
